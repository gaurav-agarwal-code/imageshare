            ...
            <div className="main" style={{ height: '92vh' }}>
                <div className="container grid grid-two-cols">
                    <div className="hero-content">
                        <p className='hero-subheading'>Welcome to ImageShare</p>
                        <h1 className='hero-heading'>Effortlessly Share Your Moments</h1>
                    ...
                    <div className="hero-image">
                        <img src="images.jpg" alt="a 3d bird" />
                    </div>
                </div>
                <div className="custom-shape-divider-bottom-1723017959">
